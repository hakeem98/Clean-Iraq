      ...
      <div className="bg-[#82B092] pt-[8rem] md:pt-[6rem] w-full h-[40vh]">
        <div className="w-full flex justify-center px-[1rem]">
          <div className="max-w-[800px] mt-[2rem] pt-[4rem]">
            ...
            <Typography
              className={`text-white font-[300] text-center md:text-end text-sm md:text-md lg:text-xl ${tajawal.className}`}
            >
            ...
            <div className="card mx-6 my-8 flex text-center flex-col">
              ...
              <div className="btn">
                <Link href={"/join/donor"}>
                  <button className="rounded-[6px] bg-[#E3AB5D] w-full py-[.5rem] text-[#000] hover:bg-opacity-90 transition">
                    شارك
                  </button>
                </Link>
              </div>
