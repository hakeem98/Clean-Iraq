      ...
      <div className="statsAndEvents relative bg-[#9DDBAD] mt-[40rem] md:mt-[20rem]">
        ...
        <div className="events pt-[8rem] pb-[6rem] container px-[2rem] sm:px-[1rem] md:px-[1.5rem] sm:mx-auto">
          ...
          <div className="events-list grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {/* 2 */}
            <Card dir="rtl" className="relative grid w-full overflow-hidden">
              <CardHeader
                floated={false}
                shadow={false}
                color="transparent"
          ...
          <div className="flex justify-center mt-[2rem]">
            <Typography
              variant="h5"
              color="dark"
              className="z-10 relative after:z-[-1] after:rounded-lg after:absolute after:w-[108%] after:bottom-0  after:left-[-4px] after:h-full after:transition after:translate-y-5 after:hover:translate-y-0 px-2 overflow-hidden after:duration-[.4s] after:bg-amber-400 cursor-pointer"
            >
              رؤية المزيد
            </Typography>
          </div>
      ...
      <div className="posts container sm:mx-auto mt-[6rem]">
        ...
        <div className="">
          ...
          <div className="post flex flex-col lg:mx-[8rem] md:flex-row px-[1rem] mt-[2rem]">
            ...
            <div
              className="postContent flex justify-center items-start flex-col pl-0 sm:pl-4"
              dir="rtl"
            >
              <Typography
                variant="h2"
        ...
        <div className="galleryList px-[2rem] md:px-[0rem]">
          <div className="container mx-auto grid gap-6 grid-cols-2 md:grid-cols-3">
            <div className="imgContainer h-[300px] sm:h-[400px] rounded-md overflow-hidden shadow-[0px_0px_0px_0px_#9DDBAD] transition hover:shadow-[5px_5px_0px_0px_#E3AB5D]">
              <div className="bg-[url('/assets/gallery/1.jpg')] w-full h-full bg-cover bg-center"></div>
            </div>

            <div className="imgContainer h-[300px] sm:h-[400px] rounded-md overflow-hidden shadow-[0px_0px_0px_0px_#9DDBAD] transition hover:shadow-[5px_5px_0px_0px_#E3AB5D]">
              <div className="bg-[url('/assets/gallery/2.jpg')] w-full h-full bg-cover bg-center"></div>
            </div>

            <div className="imgContainer h-[300px] sm:h-[400px] rounded-md overflow-hidden shadow-[0px_0px_0px_0px_#9DDBAD] transition hover:shadow-[5px_5px_0px_0px_#E3AB5D]">
              <div className="bg-[url('/assets/gallery/3.jpg')] w-full h-full bg-cover bg-center"></div>
            </div>

            <div className="imgContainer h-[300px] sm:h-[400px] rounded-md overflow-hidden shadow-[0px_0px_0px_0px_#9DDBAD] transition hover:shadow-[5px_5px_0px_0px_#E3AB5D]">
              <div className="bg-[url('/assets/gallery/4.jpg')] w-full h-full bg-cover bg-center"></div>
            </div>

            <div className="imgContainer h-[300px] sm:h-[400px] rounded-md overflow-hidden shadow-[0px_0px_0px_0px_#9DDBAD] transition hover:shadow-[5px_5px_0px_0px_#E3AB5D]">
              <div className="bg-[url('/assets/gallery/5.JPG')] w-full h-full bg-cover bg-center"></div>
            </div>

            <div className="imgContainer h-[300px] sm:h-[400px] rounded-md overflow-hidden shadow-[0px_0px_0px_0px_#9DDBAD] transition hover:shadow-[5px_5px_0px_0px_#E3AB5D]">
              <div className="bg-[url('/assets/gallery/6.jpg')] w-full h-full bg-cover bg-center"></div>
            </div>

            <div className="imgContainer h-[300px] sm:h-[400px] rounded-md overflow-hidden shadow-[0px_0px_0px_0px_#9DDBAD] transition hover:shadow-[5px_5px_0px_0px_#E3AB5D]">
              <div className="bg-[url('/assets/gallery/7.jpg')] w-full h-full bg-cover bg-center"></div>
            </div>

            <div className="imgContainer h-[300px] sm:h-[400px] rounded-md overflow-hidden shadow-[0px_0px_0px_0px_#9DDBAD] transition hover:shadow-[5px_5px_0px_0px_#E3AB5D]">
              <div className="bg-[url('/assets/gallery/8.jpg')] w-full h-full bg-cover bg-center"></div>
            </div>

            <div className="imgContainer h-[300px] sm:h-[400px] rounded-md overflow-hidden shadow-[0px_0px_0px_0px_#9DDBAD] transition hover:shadow-[5px_5px_0px_0px_#E3AB5D]">
              <div className="bg-[url('/assets/gallery/9.jpg')] w-full h-full bg-cover bg-center"></div>
            </div>
          </div>
        </div>
      </div>
